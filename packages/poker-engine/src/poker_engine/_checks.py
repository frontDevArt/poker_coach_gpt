...
`check_non_negative` названа по типу ограничения, а не по предметной
области: она обслуживает и размер банка, и число наблюдённых раздач
соперника. На модуль это правило не распространяется — две другие
функции названы доменно.
"""
