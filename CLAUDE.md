...
лесенки выплат), либо `refactor(engine)` из журнала: семь вызовов ICM в три,
единый источник предела узлов (копии `check_positive` в `bounty.py` сняты в плане 3, прогон D Задачи 1).
